<template>
  <div class="container">
    <div class="main">
      <el-page-header @back="backNotesTable" content="访客列表 > 访客详情" class="go-back"></el-page-header>
      <div class="Form_table">
        <p class="title">访客详情</p>
        <p class="time">创建时间：2020-08-30 16:15:45</p>
        <div class="item__body">
          <div class="img_box">
            <img :src="imgUrl" alt class="Img_item"/>
          </div>
          <div class="right_box">
            <div class="item">
              <p class="item_tite">姓名:</p>
              <p class="item_content">{{Name}}</p>
            </div>
             <div class="item">
              <p class="item_tite">所属公司:</p>
              <p class="item_content">{{Company}}</p>
            </div>
             <div class="item">
              <p class="item_tite">联系方式:</p>
              <p class="item_content">{{Contact}}</p>
            </div>
            <div class="item">
              <p class="item_tite">来访时间:</p>
              <p class="item_content">{{Time}}</p>
            </div>
          </div>
        </div>
        <div class="btnbox">
          <div class="ok" @click="deleteAids">删除</div>
          <div class="compile" @click="CompileStaff">编辑</div>
...
export default {
  ...
  methods: {
    ...
    //编辑员工
    CompileStaff(){
        this.$router.push(`/CompieVisitor`)
    },
     //删除监控
    deletetRole() {
