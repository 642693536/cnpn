    ...
    getPointList(){
     let param = {
      ...
      selectPointList(param).then((res) => {
        let { head, data } = res;
        if (head.code == 200) {
          this.AidForm.pointName = data.result[0].pointName;
          this.AidForm.pointAddress = data.result[0].pointAddress;
          this.AidForm.equId = data.result[0].equipmentVo.cameraName;
          this.AidForm.presetId = data.result[0].presetId
          this.MonitorId = data.result[0].equId
          let param = {
              cameraIndexCode:data.result[0].equipmentVo.cameraIndexCode
          }
...
        })
    ...
    confirmAllHandle(){
      let param = {
        ...
        pointAddress:this.AidForm.pointAddress,
        pointName:this.AidForm.pointName,
